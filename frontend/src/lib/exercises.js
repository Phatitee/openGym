...
// A build can point them somewhere else — default to CDN so deployed builds (like Vercel) work out-of-the-box.
const CDN_IMG_BASE = 'https://cdn.jsdelivr.net/gh/hasaneyldrm/exercises-dataset@7455efae41b330c265e7cd4b78dfa848e7ce5ebd/images/'
const CDN_GIF_BASE = 'https://cdn.jsdelivr.net/gh/hasaneyldrm/exercises-dataset@7455efae41b330c265e7cd4b78dfa848e7ce5ebd/videos/'

const IMG_BASE = import.meta.env.VITE_IMG_BASE || CDN_IMG_BASE
const GIF_BASE = import.meta.env.VITE_GIF_BASE || CDN_GIF_BASE
