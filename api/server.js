...
function sessionCookie(user) {
  ...
  return `gymsid=${makeSession(user)}; Path=/; Max-Age=${SESSION_DAYS * 86400}; HttpOnly;${secureFlag} ${sameSite}`;
}
const clearCookie = `gymsid=; Path=/; Max-Age=0; HttpOnly; Secure; SameSite=None;`;
